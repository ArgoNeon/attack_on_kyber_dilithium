...
/* The oracle that simulates side channel acquisition is set here to have a 99.9% probability of returning a correct value and a 0.1% probability of returning an incorrect value. */
...
{
    init_attackinfo();
    FILE * fp = fopen("result_of_attack.csv","w");
